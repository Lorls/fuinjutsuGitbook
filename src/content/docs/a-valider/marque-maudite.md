...
| Palier | Effet | Coût |
|---|---|---|
| **Dormant** | Aucun pouvoir. Simple motif sur la peau. | Nul |
| **Niveau 1** | Poussée de puissance localisée (force, vitesse, chakra). La marque s'étend sur une partie du corps. | Fatigue, douleur, murmures |
| **Niveau 2** | Transformation partielle ou totale : le chakra corrompu envahit le corps, apparence altérée, puissance décuplée. | Consumation lourde, risque de **perte de contrôle** |
| **Débordement** *(trame)* | La marque prend le dessus : le porteur agit sous son emprise, ou bascule dans un état incontrôlable. | Danger pour soi **et pour les alliés** |

> Le passage à chaque palier **au-delà du niveau 1** doit être validé par le staff sur la scène concernée.
...
Le cœur reprend **呪印** (juin, « sceau maudit »), marqué du Ciel et de la puissance :
...
- **Consentement HRP du joueur** porteur — la marque engage son personnage sur la durée.
- **Validation du staff / MJ Fuin obligatoire** à la pose **et à chaque palier**.
- Toute conséquence lourde (perte de contrôle affectant d'autres personnages, mort, bascule) requiert l'**accord HRP** des joueurs concernés.
- **Preuve** de la pose et des étapes conservée dans le suivi.
